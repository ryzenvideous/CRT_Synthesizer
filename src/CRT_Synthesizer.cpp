...
software and associated documentation files (the "Software"), specifically the executable originally named "[crtnoise.exe/CRT_Synthesizer.exe]" **and the source code files (e.g., .cpp)**, solely for personal or internal business purposes only, subject to the following conditions:

1. **No Redistribution** – The Software **may not be copied, published, distributed, shared, or sublicensed** in any form, either for free or for payment, without express written permission from the copyright holder. This applies to both the executable and the source code files (e.g., .cpp, .h), whether in their original or modified form.

2. **No Modification** – The Software **may not be modified, merged, decompiled, reverse-engineered, or used as a base for derivative works**. This applies to both the executable and the source code files (e.g., .cpp, .h), regardless of the file name or any changes made to the Software.

3. **No Resale** – The Software **may not be sold, resold, rented, or otherwise monetized** in any form, as a standalone product or as part of another product or service, without express written permission from the copyright holder. This applies to both the executable and the source code files.

4. **Retention of Copyright Notice** – This copyright notice and license terms **must remain intact** in all authorized copies of the Software, including any source code or executable files.
